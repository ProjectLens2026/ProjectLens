...
// flag every historical date mismatch (44+); The schedule review reports only the
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6">
        ...
        <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 mb-4 print:break-inside-avoid">
          <p className="text-[12px] text-slate-700 leading-relaxed mb-2">
            The schedule review detects out-of-sequence activities using the <b>P6 Schedule Log convention</b>:
