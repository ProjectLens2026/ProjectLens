        ...
        <div className="max-w-4xl mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              { name: 'ProjectLens', price: '$49', period: '/month', features: ['5 active projects', 'Full Analysis', 'Operational narrative', 'Project history & saves', 'Email support'], cta: 'Start 14-day Trial', highlight: true },
