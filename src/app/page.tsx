    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-5xl mx-auto px-8 pt-20 pb-16 text-center">
        ...
        <p className="text-xl text-slate-500 max-w-2xl mx-auto mb-10 leading-relaxed">
          Upload your Primavera P6 XER file. ControlLens finds your critical path drivers,
        ...
        <div className="rounded-2xl border border-slate-200 overflow-hidden shadow-2xl shadow-slate-200">
          <div className="bg-slate-800 px-4 py-3 flex items-center gap-2">
            ...
            <div className="ml-4 flex-1 bg-slate-700 rounded-md h-6 flex items-center px-3">
              <span className="text-slate-400 text-xs">app.control-lens.com/dashboard/upload</span>
            </div>
          </div>
      ...
      <section id="how" className="bg-slate-50 py-20">
        <div className="max-w-5xl mx-auto px-8">
          ...
          <p className="text-slate-500 text-center mb-12 max-w-xl mx-auto">No training required. No complicated setup. Just upload your XER and ControlLens does the hard work.</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { step: '01', title: 'Upload your XER', body: 'Drag and drop your Primavera P6 schedule. ControlLens parses 500+ activities and 800+ relationships in seconds.', icon: '📁' },
      ...
      <section id="features" className="py-20 max-w-5xl mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            { title: 'Critical Path Analysis', body: 'See exactly what is driving project completion. ControlLens identifies driving activities, float condition, and where the path can break.', icon: '🎯' },
            ...
            { title: 'TIA Comparison & Word Report', body: 'Upload two schedules — un-impacted and impacted. ControlLens detects fragnets, runs trend analysis, and generates a full TIA Word document ready for owner submission.', icon: '📑' },
          ].map(f => (
        ...
        <div className="max-w-4xl mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              { name: 'ControlLens', price: '$49', period: '/month', features: ['5 active projects', 'Full Analysis', 'Operational narrative', 'Project history & saves', 'Email support'], cta: 'Start 14-day Trial', highlight: true },
              { name: 'ControlLens Plus', price: '$199', period: '/month', features: ['Unlimited projects', 'TIA Comparison Engine', 'Fragnet detection & Word report', 'Multi-user team access', 'Priority support'], cta: 'Start Plus Trial', highlight: false },
            ].map(p => (
      ...
      <footer className="border-t border-slate-100 py-8 text-center text-xs text-slate-400">
        <div className="flex items-center justify-center gap-2 mb-2">
          <svg width="18" height="13" viewBox="0 0 44 32" xmlns="http://www.w3.org/2000/svg" aria-label="ControlLens mark">
            <rect x="0" y="0" width="32" height="5" rx="1" fill="#2563eb"/>
            <rect x="0" y="9" width="44" height="5" rx="1" fill="#dc2626"/>
            <rect x="0" y="18" width="26" height="5" rx="1" fill="#16a34a"/>
            <rect x="0" y="27" width="36" height="5" rx="1" fill="#1f2937"/>
        ...
        <p>Visibility. Insight. Control. © 2026 ControlLens. All rights reserved.</p>
