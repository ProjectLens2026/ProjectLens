              ...
              <div className="tab-pane">
                ...
                <div className="flex flex-wrap gap-2 mb-5">
                  {[
                    ...
                    { id: 'not-started', label: 'Activities Not Started', enabled: false, icon: '⏸️' },
                    { id: 'finished',    label: 'Activities Finished',    enabled: false, icon: '✅' },
                  ].map(f => (
                    <button
                      key={f.id}
                ...
                {scheduleFilter === 'longest' && (
                  <div>
                    <div className="bg-amber-50 border-l-4 border-amber-500 p-3 text-xs text-amber-900 mb-4 leading-relaxed">
                      <strong>Note:</strong> For now, Longest Path displays the same drivers as Critical Path. True longest-path computation through substantial and final completion is planned for a future update.
                    </div>
                    <div className="space-y-2">
                      {(a.criticalDrivers || []).slice(0, 12).map((t: any, i: number) => (
                        <div key={i} className="flex items-center gap-3 py-2 border-b border-slate-100 last:border-0 text-xs">
                ...
                {scheduleFilter === 'not-started' && (
                  <div className="text-center py-12">
                    ...
                    <div className="text-sm font-bold text-slate-700 mb-2">Activities Not Started — coming soon</div>
                    <div className="text-xs text-slate-500 max-w-md mx-auto leading-relaxed">
                      Will show all activities with no actual start date, regardless of percent complete. Ready in the next update.
                    </div>
                  </div>
                )}
                ...
                {scheduleFilter === 'finished' && (
                  <div className="text-center py-12">
                    ...
                    <div className="text-sm font-bold text-slate-700 mb-2">Activities Finished — coming soon</div>
                    <div className="text-xs text-slate-500 max-w-md mx-auto leading-relaxed">
                      Will show all activities with an actual finish date, regardless of percent complete. Ready in the next update.
                    </div>
                  </div>
                )}
              </div>
