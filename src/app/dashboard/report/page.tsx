      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6">
        ...
        {multiPathsResult && multiPathsResult.paths.length > 0 && (
          <Section>
            ...
            <Note>
              The analysis ranks the top driving chains beyond P6's single critical path.
        ...
        <div className="flex items-center justify-between pt-3 mt-6 border-t-2 text-[10px] text-slate-400" style={{ borderColor: COLORS.ink }}>
          <span>
            Prepared from the selected P6 schedule — analysis is advisory;
            the schedule of record governs.
          </span>
