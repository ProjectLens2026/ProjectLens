...
export default function SubmittalsPage(){
 ...
 return <ReportPageFrame><SubmittalsReport orgName={(project as any).company||''} reportNo={reportNumber(project.projectId||project.name,'SUB')} versionLabel={version.versionLabel||version.fileName||'Active version'} project={project} dataDate={a.dataDate||version.dataDate} submittals={Array.isArray(a.submittals)?a.submittals:[]} /></ReportPageFrame>
}
